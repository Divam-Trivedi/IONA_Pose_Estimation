...
ROOT = pathlib.Path(f"/home/hirolab/divam/FoundationPose/Combined_Final/demo_data/{Folder_Name}")
...
def main():
    ...
    predictor = build_detector(dataset_name, len(all_classes), all_classes,
                               model_path=f"/home/hirolab/divam/FoundationPose/Detectron2_Data/Detectron2_models/{model_name}.pth")
